...
folder_path = "path/to/your/directory"  # <-- replace this with your actual folder path, containing images to be analyzed
...
def all_analyze(self, int_inputs, float_inputs, scratch_orient, image_paths, mask_img):
    ...
    output_dir = f'{os.path.dirname(image_paths[0])}/results_{method}'
